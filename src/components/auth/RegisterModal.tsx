...
const RegisterModal: React.FC<RegisterModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // const errorMessagePassword = validatePassword(formData.password);
    // if (errorMessagePassword) {
    //   setErrorPassword(errorMessagePassword);
    //   return;
    // }
    // const errorMessageConfirmPassword = validatePassword(
    //   formData.confirmPassword
    // );
    // if (errorMessageConfirmPassword) {
    //   setErrorConfirmPassword(errorMessageConfirmPassword);
    //   return;
    // }
    try {
        ...
        <div>
          ...
          <div className="mt-1 relative rounded-md shadow-sm">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2  border-gray-300 
                         text-white placeholder:text-gray-400 focus:outline-none 
                         focus:ring-blue-500  bg-gray-500  p-2 rounded-lg border outline-none focus:border-blue-500 focus:bg-slate-500  my-3"
