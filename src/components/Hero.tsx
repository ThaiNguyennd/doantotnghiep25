...
import bookimg from "./public/2439.png";
import bookimg1 from "./public/2590.png";
const Hero: React.FC = () => {
  const featuredBooks = [
    {
      id: 1,
  ...
  return (
    <section className="bg-gradient-to-r from-blue-50 to-indigo-50  mt-[80px] w-full">
          ...
          {featuredBooks.map((book) => (
            <SwiperSlide key={book.id}>
              ...
              <div className="w-full h-full">
                <img src={book.cover} alt=""  className="w-full h-full object-center"/>
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
